...
class Person(override val name: String, override val age: Int, override val nationality: String, override val profession: String, override val gender: String
             ...
             , b_height:Int, b_weight:Int, b_type:String) extends Human(name,age,nationality,profession,gender) with hair with face with body    //(name,age,nationality,profession,gender)
{
  ...
  def definePerson(): Unit =
  {
    ...
    println("with "+complexion+" complexion and "+faceShape+" face and "+(if(facialHair)"with"else "having no")+" facial hair ")
...
object HumanTrait extends App {
                   ...
                   ,b_height:Int,b_weight:Int,b_type:String): Unit =
  {
    ...
    val newPerson=new Person(nme,age,nationality,profession,gender
      ,h_color,h_style
